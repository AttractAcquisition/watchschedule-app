...
| **Tables (13)** | vessels, profiles, crew_members, watch_settings, watch_lanes, schedules, watch_assignments, fairness_ledger, fairness_events, storage_uploads, chat_messages, charter_periods (B7 — client-RW charter pause windows), crew_leave (C3 — client-RW dated per-crew leave) | defined in backend.md §2; read/written per frontend.md, schedule.md, fairness.md |
