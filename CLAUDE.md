...
### The 12 tables (backend.md §2)
`vessels`, `profiles`, `crew_members`, `watch_settings`, `watch_lanes`, `schedules`, `watch_assignments`, `fairness_ledger`, `fairness_events`, `storage_uploads`, `chat_messages`, `charter_periods` (B7 — client-RW charter pause windows).
